...
set -e
psql --host=localhost -U joy2020 --dbname=postgres  -a -f database/create_db.sql
psql --host=localhost -U joy2020  --dbname=ocean_stream -a -f database/create_table.sql
...
psql --host=localhost -U joy2020 --dbname=ocean_stream -a -f database/create_table_values.sql
