...
\COPY ap_invoice(company_code, entry_type_id, pie_id, vendor_id, date,p_order_id, invoice_id) FROM    '/tmp/ap_invoice_1.csv' DELIMITER ',' CSV HEADER;

\COPY ap_invoice_item(company_code, pie_id, description, general_ledger_number, cc_id, currency_id, debit_credit, amount) FROM    '/tmp/ap_invoice_item_1.csv' DELIMITER ',' CSV HEADER;
